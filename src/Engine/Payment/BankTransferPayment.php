...
final class BankTransferPayment implements PaymentInterface
{
    ...
    public function __construct(string $method = 'bank_transfer')
    {
        $this->method = \sanitize_key($method) ?: 'bank_transfer';
    }
    ...
    public function refundPayment(array $reservation, float $amount, array $context = []): array
    {
        return [
            'success' => false,
            'method' => $this->method,
            'message' => \__('Bank transfer refunds must be handled manually.', 'must-hotel-booking'),
        ];
    }

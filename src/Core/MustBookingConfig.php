...
class MustBookingConfig
{
    ...
    public static function get_clock_settings(): array
    {
        ...
        return [
            ...
            'clock_auto_sync_batch_size' => self::int($provider['clock_auto_sync_batch_size'] ?? $defaults['clock_auto_sync_batch_size'], 10, 100, (int) $defaults['clock_auto_sync_batch_size']),
    ...
    private static function normalize_provider(array $v): array
    {
        ...
        return [
            ...
            'clock_auto_sync_batch_size' => self::int($v['clock_auto_sync_batch_size'] ?? $d['clock_auto_sync_batch_size'], 10, 100, (int) $d['clock_auto_sync_batch_size']),

...
class MustBookingConfig
{
    ...
    private static function default_storage(): array
    {
        return [
            ...
            'provider' => ['website_booking_flow_mode' => 'plugin_checkout', 'clock_wbe_inline_head_snippet' => '', 'provider_mode' => 'local', 'clock_enabled' => false, 'clock_environment' => 'production', 'clock_pms_api_enabled' => true, 'clock_base_api_enabled' => false, 'clock_pms_api_url' => '', 'clock_base_api_url' => '', 'clock_api_base_url' => '', 'clock_region' => '', 'clock_api_type' => 'pms_api', 'clock_subscription_id' => '', 'clock_account_id' => '', 'clock_api_user' => '', 'clock_api_key' => '', 'clock_property_id' => '', 'clock_wbe_hotel_id' => '', 'clock_connection_path' => '/room_types', 'clock_room_types_path' => '/room_types', 'clock_rooms_path' => '/rooms', 'clock_rates_path' => '/rates', 'clock_rates_availability_path' => '/rates_availability', 'clock_products_path' => '/products', 'clock_wbe_room_type_rates_path' => '/rates', 'clock_rate_plans_path' => '/rate_plans', 'clock_availability_path' => '', 'clock_quote_path' => '', 'clock_reservation_create_path' => '/bookings/', 'clock_reservation_status_update_path' => '', 'clock_reservation_cancel_path' => '', 'clock_reservation_room_update_path' => '', 'clock_reservation_stay_update_path' => '', 'clock_reservation_guest_update_path' => '', 'clock_reservation_fetch_path' => '/bookings/{booking_id}', 'clock_webhook_secret' => '', 'clock_timeout_seconds' => 15, 'fallback_to_local_when_clock_unavailable' => false],
            'maintenance' => [],
        ];
    }

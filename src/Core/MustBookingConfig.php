...
class MustBookingConfig
{
    ...
    public static function get_clock_settings(): array
    {
        ...
        return [
            ...
            'clock_webhook_sns_topic_arn' => \sanitize_text_field((string) ($provider['clock_webhook_sns_topic_arn'] ?? $defaults['clock_webhook_sns_topic_arn'])),
    ...
    private static function normalize_provider(array $v): array
    {
        ...
        return [
            ...
            'clock_webhook_sns_topic_arn' => \sanitize_text_field((string) ($v['clock_webhook_sns_topic_arn'] ?? $d['clock_webhook_sns_topic_arn'])),

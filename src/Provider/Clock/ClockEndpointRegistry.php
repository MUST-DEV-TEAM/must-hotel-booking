...
final class ClockEndpointRegistry
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'folio_credit_items_list' => self::definition('folio_credit_items_list', 'Folio credit items list', 'GET', '/folios/{folio_id}/credit_items', 'base_api', 'Reads folio payments and supports exact first-level reference filtering.', '', false, ['folio_id'], ['folio_id']),
            'folio_credit_item_view' => self::definition('folio_credit_item_view', 'Folio credit item view', 'GET', '/folios/{folio_id}/credit_items/{credit_item_id}', 'base_api', 'Reads one Clock payment by its durable credit-item ID.', '', false, ['folio_id', 'credit_item_id'], ['folio_id', 'credit_item_id']),

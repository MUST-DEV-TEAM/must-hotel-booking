    ...
    protected function render(): void
    {
        ...
        >
            <?php if ($wbeInlineMode && !$wbeReady) : ?>
                <?php if ($wbeWarningMarkup !== '') : ?>
                    <?php echo $wbeWarningMarkup; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                <?php endif; ?>
            <?php elseif ($wbeInlineMode) : ?>
                <form class="must-hotel-booking-booking-search" method="get" action="" data-clock-pms-wbe-form data-must-hotel-booking-mode="clock_wbe_inline">
            ...
            <?php else : ?>
                <form class="must-hotel-booking-booking-search" method="get" action="<?php echo \esc_url($booking_url); ?>" data-must-hotel-booking-mode="plugin_checkout">
                    <div class="must-hotel-booking-booking-search-fields">
                        <div class="must-hotel-booking-field must-hotel-booking-field-date must-hotel-booking-field-checkin">
                            <label class="screen-reader-text" for="<?php echo \esc_attr($checkin_id); ?>"><?php echo \esc_html__('Check In Date', 'must-hotel-booking'); ?></label>
                            <input

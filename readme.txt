...
= 0.4.0 =
* Added Clock PMS provider integration â€” the plugin now supports two booking modes: Local (self-contained, unchanged) and Clock (mirrors reservations to an external PMS via REST API).
